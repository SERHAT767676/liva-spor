...
**18 Tem mobil turu:** hero videosu mobilde de oynuyor (dikey 1.4MB); tekme figürü sahne sonunda küçülüp kenara çekiliyor (mobil+masaüstü); taekwondo görselindeki Ai filigranı silindi (canlıda doğrulandı).
**18 Tem son karar (`fa2900a`):** Otomatik oynatma denendi ve VAZGEÇİLDİ — Serhat kararıyla geçişler yine **scroll'a bağlı (pin+scrub)**; bu "geri gelince tekrar oynasın" isteğini de doğal çözer. Sahnelerde alt ortada nabız atan **"Kaydırmaya devam et"** hatırlatıcısı var (sonda kaybolur). Hero'daki "Keşfetmek için kaydır" butonu anchor yerine bir ekran boyu kaydırıyor (alta atma sorunu çözüldü).
...
**Google kayıtları (18 Tem) ✅:** Search Console zaten önceden kuruluymuş (eski oturumdan), sitemap "Başarılı" durumda. Google Business Profile kaydı Serhat tarafından oluşturuldu — **Google'ın işletme doğrulaması bekleniyor** (video/kod; birkaç gün sürebilir). Onay gelince: 8-10 salon fotoğrafı + ilk gönderi (ücretsiz deneme dersi) + mesajlaşma açık + veli yorumları istenecek.
**18 Tem "jimnastik" SEO turu (LOKAL — henüz push edilmedi):** Sitede her yerde "cimnastik" yazdığı için "jimnastik" aramaları zayıftı. Yapılanlar: SSS'e "Jimnastik mi cimnastik mi?" sorusu eklendi (FAQPage şemasına otomatik giriyor), keywords'e jimnastik varyantları eklendi (description'a parantezli "jimnastik" eklenmişti, Serhat istemedi → geri alındı) (Yandex için; Google keywords'ü yok sayıyor). "jimlastik/cimlastik" gibi yazım hatalarına bilerek dokunulmadı — Google kendisi düzeltiyor. Build ✅. **Push için Serhat onayı bekleniyor.**
