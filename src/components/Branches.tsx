              ...
              <div className="relative flex-1 p-6 sm:p-8 text-white flex flex-col justify-center min-h-[260px]">
                ...
                >
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 w-fit font-bold text-sm px-6 py-3 rounded-xl bg-white text-teal-dark hover:bg-gray-light transition-all duration-300 hover:scale-105 shadow-lg"
                  >
                    Bilgi Al
              ...
              <div className="relative flex-1 p-6 sm:p-8 text-white flex flex-col justify-center min-h-[260px]">
                ...
                >
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 w-fit font-bold text-sm px-6 py-3 rounded-xl bg-white text-primary hover:bg-gray-light transition-all duration-300 hover:scale-105 shadow-lg"
                  >
                    Bilgi Al
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
