    ...
    <footer className="w-full bg-dark border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <nav aria-label="Alt menü" className="flex flex-col gap-3">
          ...
          {quickLinks.map((l) => (
            <a key={l.href} href={l.href}
              className="text-white/45 hover:text-teal text-sm transition-colors duration-200 w-fit">
              {l.label}
            </a>
          ))}
        </nav>
        ...
        <div className="flex flex-col gap-3">
          ...
          <a href="tel:+905416445376" className="text-white/45 hover:text-teal text-sm transition-colors w-fit">
            +90 541 644 53 76
          </a>
          <a href="mailto:ist.livasporkulubu@gmail.com" className="text-white/45 hover:text-teal text-sm transition-colors w-fit break-all">
          ...
          <a
            ...
            className="mt-2 inline-flex items-center gap-2 w-fit bg-teal hover:bg-teal-light text-white font-bold text-sm px-6 py-3 rounded-xl transition-all duration-300 hover:scale-105 shadow-lg shadow-teal/20"
          >
