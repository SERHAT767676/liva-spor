      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <a
            ...
            className="flex items-center min-h-11 gap-2 text-white/50 hover:text-pink-400 transition-colors duration-300 active:opacity-60"
          >
        ...
        {/* Hızlı linkler */}
        <nav aria-label="Alt menü" className="flex flex-col">
