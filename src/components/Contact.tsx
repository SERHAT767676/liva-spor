  ...
  const contactInfo = [
    {
      ...
      label: "Telefon",
      value: "+90 541 644 53 76",
      href: "tel:+905416445376",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      label: "E-posta",
      value: "ist.livasporkulubu@gmail.com",
      href: "mailto:ist.livasporkulubu@gmail.com",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    },
    {
      ...
      label: "Instagram",
      value: "@istanbullivasporkulubu",
      href: "https://www.instagram.com/istanbullivasporkulubu",
    },
  ];

  return (
    <section id="iletisim" className="py-24 bg-dark">
          ...
          <div className="space-y-5">
            {contactInfo.map((info) => (
              <a
                key={info.label}
                href={info.href}
                target={info.label === "Adres" || info.label === "Instagram" ? "_blank" : undefined}
                rel={info.label === "Adres" || info.label === "Instagram" ? "noopener noreferrer" : undefined}
                aria-label={`${info.label}: ${info.value}`}
                className="flex items-start gap-4 p-5 rounded-2xl bg-white/5 border border-white/10 hover:border-teal/30 transition-all duration-300 group"
              >
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 bg-green-600 hover:bg-green-500 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 mt-4"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
